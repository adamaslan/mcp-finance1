...
Computes returns across 11 time horizons using Pandas for efficient
...
class PerformanceCalculator:
    ...
    def get_best_performers(
        ...
        Args:
            ...
            horizon: Time horizon key (e.g., '1w', '2w', '1m', '3m').
    ...
    def get_horizon_days(cls, horizon: str) -> Optional[int]:
        ...
        Args:
            horizon: Horizon key (e.g., '1w', '1m', '3m').
