...
class IndustryService:
    ...
    async def refresh_all_industries(
        ...
        # Run all refreshes concurrently (with semaphore limiting)
        await asyncio.gather(*[refresh_one(ind) for ind in industries])
